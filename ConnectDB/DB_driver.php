...
class DB_driver{
	...
	function connect(){
		if(!$this->conn){
			...
			// Xử lý truy vấn utf8mb4 để tránh lỗi font
            mysqli_query($this->conn, "SET character_set_results = 'utf8mb4', character_set_client = 'utf8mb4', character_set_database = 'utf8mb4', character_set_server = 'utf8mb4'");
